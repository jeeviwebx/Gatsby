---
title: Connect to MemSQL Data Source | Standalone Report Designer
description: Learn how to connect MemSQL database and feed data to your RDL reports using Bold Reports Cloud Reporting.
canonical: /enterprise-reporting/designer-guide/report-designer/manage-data/data-connectors/memsql-data-source/
---

# Connect to MemSQL data source

The Bold Reports<sup>®</sup> Designer supports connecting MemSQL database using SQL Query.
...
### Connecting to a MemSQL data source through SSH Tunnel

You can now connect to a MemSQL data source using a secure SSH tunnel. This enhancement provides a more robust and secure method for connecting, especially when accessing remote databases over untrusted or insecure networks.
