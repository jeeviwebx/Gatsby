---
title: Connect to MySQL Data Source | Standalone Report Designer
description: Learn how to connect to MySQL data source and feed data to your RDL reports using Standalone Report Designer.
canonical: /enterprise-reporting/designer-guide/report-designer/manage-data/data-connectors/mysql-data-source/
---

# Connect to MySQL data source

The Bold Reports<sup>®</sup> Designer supports connecting MySQL database using SQL Query.
...
### Create MySQL data source with basic options
...
4. Specify the username of your MySQL server in **Username** field.
5. Specify the password of your MySQL server in **Password** field.
...
### Connecting to a MySQL data source through SSH Tunnel

You can now connect to a MySQL data source using a secure SSH tunnel. This enhancement provides a more robust and secure method for connecting, especially when accessing remote databases over untrusted or insecure networks.
...
### Create MySQL data source with advanced options

To connect the MySQL database with advanced options, click on the `Advanced Options` in `New Data` panel.
...
Set the connection string and input the username and password of MySQL server.
